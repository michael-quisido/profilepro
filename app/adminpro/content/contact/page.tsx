  ...
  return (
    <div style={{ minHeight: "100vh", background: "#f5f5f5" }}>
      ...
      <div style={{ padding: "40px", maxWidth: "1000px", margin: "0 auto" }}>
        <h2 style={{ marginBottom: "10px", color: "#333" }}>Edit Contact Page</h2>
        <div style={{ display: 'flex', gap: '20px', marginBottom: '30px' }}>
          ...
          <Link href="/adminpro/content/contact" style={{ padding: '8px 16px', background: '#c9a227', color: 'white', borderRadius: '5px', textDecoration: 'none' }}>Contact</Link>
        </div>
        
        <div style={{ background: "white", padding: "30px", borderRadius: "15px", marginBottom: "30px" }}>
          <h3 style={{ marginBottom: "20px", color: "#333" }}>Contact Content</h3>
          <RichTextEditor
            value={content}
            onChange={setContent}
          />
